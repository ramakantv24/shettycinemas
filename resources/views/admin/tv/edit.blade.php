          ...
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"> Tv <span class="card-description">
				...
				@endif
				<form role="form" action="{{ asset('admin/edit_tv_action') }}" method="POST" enctype='multipart/form-data'>
				@CSRF
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('tv_number') is-invalid @enderror" name="tv_number" id="tv_number" value="{{ $TvtypeInfo->tv_number }}" required placeholder="Tv Number">
				    @error('tv_number')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
				...
				<div class="form-group">
                  ...
                  <input type="text" class="form-control @error('tv_name') is-invalid @enderror" name="tv_name" id="tv_name" value="{{ $TvtypeInfo->tv_name }}" required placeholder="Tv Name">
				    @error('tv_number')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
